<section class="contact-infos" itemscope itemtype="http://schema.org/ContactPage">
    <div class="container contact-infos--container">
        <div class="contact-infos--container--channels" itemscope itemtype="http://schema.org/Organization">
            <div class="contact">
                <ul class="items">
                    <?php
                    $args = array(
                    ...
                    ?>
                        ...
                        <li class="item scroll-effect" itemprop="telephone" itemscope itemtype="http://schema.org/ContactPoint">
                        ...
                        <li class="item scroll-effect" itemprop="address" itemscope itemtype="http://schema.org/PostalAddress">
                        ...
                        <li class="item scroll-effect" itemprop="sameAs" itemscope itemtype="http://schema.org/WebPage">
                            <a href="https://api.whatsapp.com/send?phone=<?php echo $whatsappNumber ?>" itemprop="url">
                                ...
                                <span itemprop="name"><?php echo $whatsapp ?></span>
                            </a>
                        </li>
                        <?php if($instagram): ?>
                        <li class="item scroll-effect">
                            <a href="<?php echo $instagram ?>">
                                ...
                                <span itemprop="name"><?php echo $instagram ?></span>
                            </a>
                        </li>
                        <?php endif; ?>
                        <?php if($facebook): ?>
                        <li class="item scroll-effect" itemprop="sameAs" itemscope itemtype="http://schema.org/WebPage">
                            <a href="<?php echo $facebook ?>" itemprop="url">
                                ...
                                <span itemprop="name"><?php echo $facebook ?></span>
                            </a>
                        </li>
                        <?php endif; ?>
                    <?php endwhile; ?>
        ...
        <div class="contact-infos--container--form" itemscope itemtype="http://schema.org/ContactPoint">
